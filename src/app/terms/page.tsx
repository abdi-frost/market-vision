...
export default function TermsPage() {
  return (
    <main className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl p-8 shadow-lg">
        <h1 className="text-2xl font-semibold mb-4 text-slate-900 dark:text-slate-50">Terms & Disclaimer</h1>
        ...
        <h2 className="text-lg font-medium mt-4 mb-2 text-slate-900 dark:text-slate-50">Not Financial Advice</h2>
        <p className="mb-4 text-slate-700 dark:text-slate-300">
        ...
        <h2 className="text-lg font-medium mt-4 mb-2 text-slate-900 dark:text-slate-50">Personal Use & Educational Purpose</h2>
        <p className="mb-4 text-slate-700 dark:text-slate-300">
        ...
        <h2 className="text-lg font-medium mt-4 mb-2 text-slate-900 dark:text-slate-50">No Guarantees</h2>
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/"
            className="text-sm font-medium bg-slate-100 dark:bg-slate-800 px-3 py-2 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-slate-900 dark:text-slate-50"
          >
